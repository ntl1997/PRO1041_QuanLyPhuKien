...
public class ScanQRProduct extends javax.swing.JDialog implements Runnable, ThreadFactory {

    private WebcamPanel panel = null;
    private Webcam webcam = null;
    private QRCodeScannerCallback callback;

    private static final long serialVersionUID = 6441489157408381878L;
    private Executor executor = Executors.newSingleThreadExecutor(this);
    SanPhamDao sanpham = new SanPhamDao();
    List<SANPHAM> listsp = sanpham.selectAll();

    public ScanQRProduct(JDialog parent, boolean modal, QRCodeScannerCallback callback) throws IOException {
        super(parent, "Quét mã sản phẩm", modal);
...
//        setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE);
    ...
    public void run() {
        do {
            ...
            System.out.println("Image captured: " + (image != null));
